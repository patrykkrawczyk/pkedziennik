...
import { SalaDialogComponent } from '../../../../../../main/webapp/app/entities/sala/sala-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Sala Management Dialog Component', () => {
        let comp: SalaDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(SalaDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'salaListModification', content: 'OK'});
